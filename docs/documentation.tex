...
$\vert$ $"pick"$ expr $";"$ \\
$\vert$ $"put"$ expr $","$ expr $";"$ \\
$\vert$ getter $"."$ listVoidFunc $";"$ \\

listVoidFunc $\rightarrow$ $"push"$ expr $\vert$ $"pop"$ $\vert$ $"reverse"$ \\
...
idTail $\rightarrow$ id $\vert$ listValueFunc \\

listValueFunc $\rightarrow$ $"get"$ expr $\vert$ $"size"$ \\
